            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="color-print">Color Print (per page)</Label>
                    <div className="relative">
                      <span className="absolute left-3 top-3 text-sm">₹</span>
                      <Input
                        id="color-print"
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            ...
                            delete all your shop data including customers,
                            orders, and settings.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
